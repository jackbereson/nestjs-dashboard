...
const ModalCreateSport = ({
  ...
  const submit = (
    values: CreateSportInput,
    { setSubmitting }: FormikHelpers<CreateSportInput>
  ) => {
    createData({...values});
  ...
  const createData = (data: CreateSportInput) => {
    setLoading(true)(dispatch);
    const token = getUserToken(false);
    SportService.create({ data, token })
      .then(() => {
        loadData();
  ...
  return (
    ...
    >
      <Formik
        initialValues={SportInitialValues}
