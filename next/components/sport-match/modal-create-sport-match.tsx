...
import {
  SportMatchArgNames,
  SportMatchArgs,
  SportMatchInitialValues,
  CreateSportMatchInput,
...
const ModalCreateSportMatch = ({
  ...
  const submit = (
    values: CreateSportMatchInput,
    { setSubmitting }: FormikHelpers<CreateSportMatchInput>
  ) => {
    createData({...values});
  ...
  const createData = (data: CreateSportMatchInput) => {
    setLoading(true)(dispatch);
    const token = getUserToken(false);
    SportMatchService.create({ data, token })
      .then(() => {
        loadData();
  ...
  return (
    <Dialog
      ...
      mobileMode={false}
      title="Create new sportMatch"
    >
      <Formik
        initialValues={SportMatchInitialValues}
...
export default ModalCreateSportMatch;
