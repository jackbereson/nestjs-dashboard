...
const ModalDeleteBalanceTransaction = ({
  data,
  open,
  setOpen,
  loadData,
  ...
  const confirmDelete = () => {
    ...
    const id = data.id;
    BalanceTransactionService.delete({ id, token })
      .then(() => {
        loadData();
  ...
  return (
    <AlertDialog
      ...
      onClose={closeModal}
      title="Delete balanceTransaction"
      content="Are you sure you want to delete this data ?"
    />
  );
};

export default ModalDeleteBalanceTransaction;
