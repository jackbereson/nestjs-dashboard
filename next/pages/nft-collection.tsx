...
import NftCollectionTableList from "../components/nft-collection/nft-collection-table-list";
import NftCollectionActionCreate from "../components/nft-collection/nft-collection-action-create";

const NftCollectionPage = (props: any) => {
  ...
  const getData = async ({
    ...
    NftCollectionService.getAll({
      ...
      token,
      cache: false,
      fragment: NftCollectionService.fullFragment,
    })
      .then(handleResult)
      .catch(handleError);
  };
...
NftCollectionPage.Layout = AdminLayout;
  ...
  return (
    <PageHeader>
      ...
      <PageHeaderFunctions setViewMode={setViewMode}>
        ...
        <NftCollectionActionCreate loadData={loadData} />
      </PageHeaderFunctions>
    </PageHeader>
  );
});
