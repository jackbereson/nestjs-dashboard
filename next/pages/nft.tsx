...
import NftActionImport from "../components/nft/nft-action-import";
  ...
  return (
    <PageHeader>
      ...
      <PageHeaderFunctions setViewMode={setViewMode}>
        ...
        {/* <NftActionCreate loadData={loadData} /> */}
        {/* {user?.role === ROLES.ADMIN && currentAccount && <NftActionMintExistedNFTs />} */}
      </PageHeaderFunctions>
    </PageHeader>
  );
});
