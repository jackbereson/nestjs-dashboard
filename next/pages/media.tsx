...
import MediaTableList from "../components/media/media-table-list";
import MediaActionCreate from "../components/media/media-action-create";
  ...
  return (
    <PageHeader>
      ...
      <PageHeaderFunctions setViewMode={setViewMode}>
        ...
        <MediaActionCreate loadData={loadData} />
      </PageHeaderFunctions>
    </PageHeader>
  );
});
...
const Table = ({
  ...
  return (
    <div className="bg-seconds-light pb-1">
      <TableListWrapper>
        <MediaTableList data={data} loadData={loadData} viewMode={viewMode} />
      </TableListWrapper>
      <Paging
